...
public class ManufacturerDAOImpl_Hibernate implements ManufacturerDAO {

    private final SessionFactory sessionFactory;
    @Override
    @Transactional(readOnly = true)
    public List<Manufacturer> findAll() {
        return Collections.unmodifiableList(sessionFactory.getCurrentSession().createQuery("FROM Manufacturer m")
                .list());
    }
